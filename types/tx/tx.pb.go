...
type AuthInfo struct {
	...
	// secondary_chain_id is only filled if this transaction is a non-native
	// transaction.
	SecondaryChainId string `protobuf:"bytes,4,opt,name=secondary_chain_id,json=secondaryChainId,proto3" json:"secondary_chain_id,omitempty"`
}
...
func (m *AuthInfo) GetSecondaryChainId() string {
	if m != nil {
		return m.SecondaryChainId
	}
	return ""
}
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
...
func (m *AuthInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SecondaryChainId) > 0 {
		i -= len(m.SecondaryChainId)
		copy(dAtA[i:], m.SecondaryChainId)
		i = encodeVarintTx(dAtA, i, uint64(len(m.SecondaryChainId)))
		i--
		dAtA[i] = 0x22
	}
	if m.Tip != nil {
...
func (m *AuthInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecondaryChainId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SecondaryChainId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
