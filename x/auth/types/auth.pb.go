...
type BaseAccount struct {
	...
	SecondarySequence map[string]uint64 `protobuf:"bytes,5,rep,name=secondary_sequence,json=secondarySequence,proto3" json:"secondary_sequence,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func init() {
	...
	proto.RegisterMapType((map[string]uint64)(nil), "cosmos.auth.v1beta1.BaseAccount.SecondarySequenceEntry")
...
var fileDescriptor_7e1f7e915d020d2d = []byte{
	...
	,
}
...
func (m *BaseAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SecondarySequence) > 0 {
		for k := range m.SecondarySequence {
			v := m.SecondarySequence[k]
			baseI := i
...
func (m *BaseAccount) Size() (n int) {
	...
	if len(m.SecondarySequence) > 0 {
		for k, v := range m.SecondarySequence {
			_ = k
			_ = v
...
func (m *BaseAccount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecondarySequence", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SecondarySequence == nil {
				m.SecondarySequence = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
			...
			m.SecondarySequence[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAuth(dAtA[iNdEx:])
